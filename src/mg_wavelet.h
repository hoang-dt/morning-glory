...
mg_T(t) void FLiftCdf53X(grid_volume* Grid, const v3i& M);
mg_T(t) void FLiftCdf53Y(grid_volume* Grid, const v3i& M);
mg_T(t) void FLiftCdf53Z(grid_volume* Grid, const v3i& M);
mg_T(t) void ILiftCdf53X(grid_volume* Grid, const v3i& M);
mg_T(t) void ILiftCdf53Y(grid_volume* Grid, const v3i& M);
mg_T(t) void ILiftCdf53Z(grid_volume* Grid, const v3i& M);
