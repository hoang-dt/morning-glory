...
array<grid, 8> Split3D(const v3i& Dims) {
  ...
  array<grid, 8> Vols;
  Vols[0] = grid(v3i(0, 0, 0), v3i(1, 1, 1));
  Vols[1] = grid(v3i(1, 0, 0), v3i(Dims.X - 1, 0, 0));
  Vols[2] = grid(v3i(0, 1, 0), v3i(0, Dims.Y - 1, 0));
  Vols[3] = grid(v3i(0, 0, 1), v3i(0, 0, Dims.Z - 1));
  Vols[4] = grid(v3i(1, 1, 0), v3i(Dims.X - 1, Dims.Y - 1, 0));
  Vols[5] = grid(v3i(0, 1, 1), v3i(0, Dims.Y - 1, Dims.Z - 1));
  Vols[6] = grid(v3i(1, 0, 1), v3i(Dims.X - 1, 0, Dims.Z - 1));
  Vols[7] = grid(v3i(1, 1, 1), v3i(Dims.X - 1, Dims.Y - 1, Dims.Z - 1));
  return Vols;
}
