...
//void
//WriteTile8(const extent& Tile8, volume* Vol, const array<i8>& Count,
//           const file_format& Wz, array<grid> Tile8s, int Level, bool LastTile)
//{
//  /* perform wavelet transform on the current tile8 */
//  ForwardCdf53(Tile8, 1, Vol); // TODO: normalize the coefficients
