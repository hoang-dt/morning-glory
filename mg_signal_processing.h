...
void ConvertToNegabinary(const i64* FIn, i64 Size, u64* FOut, data_type Type = data_type::int64);
void ConvertFromNegabinary(const u64* FIn, i64 Size, i64* FOut, data_type Type = data_type::int64);
